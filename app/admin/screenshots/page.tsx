    ...
    try {
      ...
      if (res.ok && data.success) {
        ...
        toast({
          ...
          description:
            "Don't forget to click 'Update Screenshot' to save your changes.",
          duration: 5000,
        });
      } else {
        ...
        toast({
          variant: "destructive",
          title: "Upload Failed",
          description: data.error || "Server did not return a valid response.",
        });
        setImagePreview("");
      }
    } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const url = editingScreenshot
        ? `/api/screenshots/${editingScreenshot.id}`
        : "/api/screenshots";
      ...
      if (response.ok) {
        ...
        toast({
          ...
          description: `Screenshot ${
            editingScreenshot ? "updated" : "added"
          } successfully!`,
        });
      } else {
            ...
            {screenshots.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">
                  Add your first app screenshot to get started.
                </p>
